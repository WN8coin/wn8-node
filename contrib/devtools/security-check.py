...
CHECKS = {
    lief.EXE_FORMATS.ELF: {
        lief.ELF.ARCH.i386: BASE_ELF + [('CONTROL_FLOW', check_control_flow)],
        lief.ELF.ARCH.ARM: BASE_ELF,
        lief.ELF.ARCH.PPC: BASE_ELF,
    },
    lief.EXE_FORMATS.PE: {
        lief.ELF.ARCH.i386: BASE_PE,
    },
    lief.EXE_FORMATS.MACHO: {
        lief.ELF.ARCH.i386: BASE_MACHO + [('PIE', check_PIE),
                                              ('NX', check_NX),
                                              ('CONTROL_FLOW', check_control_flow)],
        lief.ELF.ARCH.x86_64: BASE_MACHO,
    }
}
...
def identify_executable(executable) -> Optional[str]:
    ...
    if magic.startswith(b'MZ'):
        return lief.EXE_FORMATS.PE
    elif magic.startswith(b'\x7fELF'):
        return lief.EXE_FORMATS.ELF
    elif magic.startswith(b'\xcf\xfa'):
        return lief.EXE_FORMATS.MACHO
    return None
