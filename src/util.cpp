...
bool fMasternodeAccess = false;
bool fLiteMode = false;
int nWalletBackups = 10;

const char * const BITCOIN_CONF_FILENAME = "wn8.conf";
const char * const BITCOIN_PID_FILENAME = "wn8d.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
	...
	fs::path firoDefaultDir = GetDefaultDataDirForCoinName("wn8");
...
std::string CopyrightHolders(const std::string& strPrefix)
{
	...
	if (copyright_devs.find(_("WN8 Core")) == std::string::npos) {
		strCopyrightHolders += '\n' + strPrefix + "The WN8 Core developers";
	}
