...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
		...
		std::string strUsage = strprintf(_("%s wn8-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
			  "  wn8-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Firo transaction") + "\n" +
			  "  wn8-tx [options] -create [commands]   " + _("Create hex-encoded Firo transaction") + "\n" +
              "\n";
