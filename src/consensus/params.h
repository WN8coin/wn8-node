...
struct Params {
	...
	/** First Subsidy Halving Parameters */
	/** End of First Period Estimated at Genesis Block Time */
	int nFirstSubsidyHalvingEndPeriod;

	/** First Halvin Percent */
	int nFirstSubsidyHalvingValue;

	/** Second Subsidy Halving Parameters */
	/** End of Third Period Estimated at Genesis Block Time */
	int nSecondSubsidyHalvingEndPeriod;

	/** Second Halvin Percent */
	int nSecondSubsidyHalvingValue;


	/** Third Subsidy Halving Parameters */
	/** End of Third Period Estimated at Genesis Block Time */
	int nThirdSubsidyHalvingEndPeriod;

	/** Third Halvin Percent */
	int nThirdSubsidyHalvingValue;

	/** percentage of block subsidy going to miners fund */
	int nSubsidyHalvingMinersShare;

	/** percentage of block subsidy going to nodes fund */
	int nSubsidyHalvingNodesShare;

	/** percentage of nodes block subsidy going to developer fund */
	int nSubsidyHalvingDevelopShare;

	std::string subsidyDevelopFundAddress;
