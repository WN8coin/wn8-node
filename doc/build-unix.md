...
This will build wn8-qt as well if the dependencies are met.
...
Once these are installed, they will be found by configure and a wn8-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip wn8d" to strip the debug
