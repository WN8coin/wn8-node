...
WN8 Core is now available at `./src/wn8d`
...
The first time you run wn8d, it will start downloading the blockchain. This process could take several hours.
...
-------
    ...
    ./src/wn8d -daemon # Starts the Firo daemon.
	./src/wn8-cli --help # Outputs a list of command-line options.
	./src/wn8-cli help # Outputs a list of RPC commands when the daemon is running.
