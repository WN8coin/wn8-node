...
Please note that we currently don't support the GUI when running with Docker. Therefore, you can only use RPC (via HTTP or the `wn8-cli` utility) to interact with Firo via this method.

Pull our latest official Docker image:

```sh
docker pull firoorg/wn8d
```

Start Firo daemon:

```sh
docker run -d --name wn8d -v "${HOME}/.firo:/home/wn8d/.firo" firoorg/wn8d
```
...
```sh
docker cp wn8d:/home/wn8d/.firo/wallet.dat .
```
